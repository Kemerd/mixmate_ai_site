...
const faqs = [
    ...
    },
    {
        ...
        answer: "Coming soon! Right now, MixMate provides specific, actionable suggestions and tells you exactly which knobs to turn. But we're building full DAW control so MixMate can make the changes for you—if you're brave enough to let an AI touch your precious project.",
    },
    {
        question: "Will MixMate make me a better producer or just make me lazy?",
        answer: "Both, probably. MixMate explains its reasoning instead of just applying generic presets, so you'll actually learn production techniques that no $2,000 masterclass would teach you. But let's be honest—if you're the type of person who uses AI to mix your tracks, you were probably already looking for shortcuts. At least now your shortcuts will sound professional.",
    },
    {
